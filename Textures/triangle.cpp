 ...
 * @LastEditTime: 2022-04-13 15:30:46
...
int main(int argc, const char* argv[])
{
    ...
    uint8_t* textureData = stbi_load("../../../wall.jpg", &textureWidth, &textureHeight, &textuteNrChannels, 0);
    if(textureData)
    {
        // 附加纹理图像到绑定的当前纹理对象
