/*** 
 * @Author: pananfly
 * @Date: 2022-04-15 16:31:10
 * @LastEditTime: 2022-04-15 16:43:37
 * @LastEditors: pananfly
 * @Description: 
 * @FilePath: \Textures\texture7.cpp
 * @pananfly
 */
#include <glad/glad.h>
...
int main(int argc, const char* argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 使用lookAt模拟相机运动
        // 相机运动圆路线半径
        float cameraLookRadius = 10.0f;
        // x轴变换
        float cameraX = std::sin(glfwGetTime()) * cameraLookRadius;
        // z轴变换
        float cameraZ = std::cos(glfwGetTime()) * cameraLookRadius;
